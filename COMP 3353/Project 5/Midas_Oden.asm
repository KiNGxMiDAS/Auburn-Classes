...
; Author: Midas Oden
; Last Modified Date: Wednesday, 14 April 2021
...
include C:\Irvine\Irvine32.inc              ; Include file used with the Irvine32 link library (32-bit applications).
includelib C:\Irvine\Irvine32.lib           ; Irvine32-bit link library — uses stdcall.
...
.code
    main proc
        ...
        MOVEON:
            mov eax, 0
			lea edx, output                 ; assign address of 'output' array to EDX — return output to console. Requires Irvine32 library.
			call WriteString                ; writes a null-terminated string to the console window — display string of text.
