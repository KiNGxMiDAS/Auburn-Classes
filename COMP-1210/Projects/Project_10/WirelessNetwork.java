...
// Methods
 ...
 //                          PART 2 ~ PROJECT 10                              //
  ...
  /**
   * Method to compare WirelessNetwork objects based on 
   * their respective name fields.
   *
   * @param object represents a WirelessNetwork object
   * @return Returns an integer value.
   */
  
   public int compareTo(WirelessNetwork object) {
   
      return name.toLowerCase().compareTo(object.getName()
            .toLowerCase());
